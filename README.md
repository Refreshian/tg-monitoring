...
- **Маркетинговый сайт** — информация о компании и услугах
- **Предпросмотр упоминаний** — пользователь вводит поисковый запрос и видит найденные сообщения до заказа доступа
- **Интеграция с brandanalytics.ru** — автоматический сбор через Playwright
- **Telegram** (планируется) — автоматическая отправка новых упоминаний
